...
def get_seg_model(**kwargs):
    ...
    #yaml_config_path = './model/HR_Net/seg_hrnet_w48.yaml'
    yaml_config_path = r'./detection_models/iim/model/HR_Net/seg_hrnet_w48.yaml'  # TODO: use relative paths
    update_config(hr_config, yaml_config_path)
    model = HighResolutionNet(hr_config, **kwargs)
    from detection_models.iim.config import cfg  # TODO: use relative paths
